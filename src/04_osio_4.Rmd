# 4. QGIS-toimintaympäristön käyttöönotto
...
## 4.1. QGIS- projektin avaaminen

### 4.1.1. Avaaminen lisäosalla
...
![](img/osio_4/image_1.png)

### 4.1.2. Avaaminen tietokannasta
